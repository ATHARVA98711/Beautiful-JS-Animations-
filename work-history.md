...
- 2026-09-16 (frog hop): Duplicated `halftone-boat-beautiful.html` -> `halftone-frog.html` (original untouched). 3s dusk moment: frog idles on hero pad (breathing + blinks every ~3.7s), crouches 8.6-9.0s (squash + pad dips 4px), flies 9.0-9.95s (72px parabola, stretch, legs trail), splashes with 6 droplets + 3 fading ripple rings till 12.5s, hidden at night, fades back at dawn 18.3-19.6s. Frog vector-drawn per frame (~15 ops, night-lerped greens) so 60fps cache intact. All lilies upgraded: real notch wedge + top highlight + dark rim; random pads nudged clear of hero pad. [ADD NEW ENTRIES HERE with date + what worked/failed + user feedback]
